    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-[#0c1427] border border-cyan-500/40 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl space-y-4">
          ...
          <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                <span className="font-bold text-cyan-300 font-mono">{post.username}</span>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/80 flex items-center justify-between font-sans text-xs">
          <button
            onClick={copyPayload}
            className="px-3.5 py-2 rounded-xl bg-slate-800 border border-slate-700 hover:border-cyan-500/50 text-slate-200 text-xs flex items-center gap-1.5 transition font-medium"
          >
            <Copy className="w-3.5 h-3.5 text-cyan-400" /> Copy Post Info
          </button>
