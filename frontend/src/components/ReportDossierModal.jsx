...
export default function ReportDossierModal({ isOpen, onClose, initialTopic = '' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      <div className="bg-[#080e1e] border border-blue-500/40 rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden print:max-w-none print:max-h-none print:border-none print:shadow-none print:rounded-none print:bg-white print:text-black">
        
        {/* Top Operational Action Bar (Hidden on Print) */}
        <div className="p-4 bg-[#050b18] border-b border-blue-950 flex flex-wrap items-center justify-between gap-3 print:hidden font-sans">
          <div className="flex items-center gap-2">
            <div className="p-2 rounded-xl bg-blue-950 border border-blue-500/50 text-blue-400">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 bg-[#030712] border border-blue-950 rounded-xl px-2.5 py-1">
              ...
              <select
                ...
                className="bg-transparent text-xs text-blue-300 outline-none cursor-pointer"
              >
                <option value="" className="bg-[#080e1e] text-white">All Monitored Threats</option>
                <option value="#BankingScam" className="bg-[#080e1e] text-white">#BankingScam (Fake Bank Messages)</option>
                <option value="#DeepfakeAlert" className="bg-[#080e1e] text-white">#DeepfakeAlert (AI Fake Audio/Video)</option>
                <option value="#UPSCProtest" className="bg-[#080e1e] text-white">#UPSCProtest (Student Rallies)</option>
                <option value="#BoycottOnlineRetailers" className="bg-[#080e1e] text-white">#BoycottOnlineRetailers (Spam)</option>
              </select>
            </div>
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 hover:from-blue-600 hover:to-indigo-600 text-white text-xs font-bold flex items-center gap-1.5 transition shadow-lg shadow-blue-950 disabled:opacity-50 border border-blue-500/40"
            >
        ...
        <div className="p-6 sm:p-8 space-y-6 overflow-y-auto flex-1 font-sans print:p-0 print:overflow-visible">
          {loading ? (
            <div className="py-24 text-center space-y-3 font-sans">
              ...
              <p className="text-sm text-blue-300">Compiling safety summary and fake account findings...</p>
            </div>
          ) : dossier ? (
            <div className="space-y-6 print:text-black">
              {/* Top Classification Header */}
              <div className="bg-[#050b18] border border-blue-500/40 text-blue-300 text-center py-2 text-[11px] font-bold tracking-widest uppercase rounded-lg print:bg-slate-100 print:text-black print:border-black font-mono">
                {dossier.classification_banner || 'OFFICIAL CYBER SAFETY ADVISORY // TECH NETRA'}
              </div>

              {/* Header Info */}
              <div className="border-b-2 border-blue-500/40 pb-4 flex flex-col sm:flex-row sm:items-end justify-between gap-4 print:border-black">
                <div>
              ...
              <div className="space-y-3">
                <h2 className="text-sm font-bold uppercase tracking-wider text-blue-400 border-b border-blue-950 pb-1 flex items-center gap-2 print:text-black print:border-black font-sans">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 font-sans">
                  <div className="p-3.5 rounded-xl bg-[#050b18] border border-blue-950 print:bg-slate-50 print:border-slate-300">
                  ...
                  <div className="p-3.5 rounded-xl bg-[#050b18] border border-blue-950 print:bg-slate-50 print:border-slate-300">
                    ...
                    <span className="text-lg font-bold text-blue-300 font-mono print:text-blue-700">{dossier.estimated_reach.toLocaleString()} people</span>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs border border-blue-950 rounded-xl overflow-hidden print:border-black font-sans">
                    <thead className="bg-[#050b18] text-slate-300 print:bg-slate-100 print:text-black">
                      <tr className="border-b border-blue-950 print:border-black">
                    ...
                    <tbody className="divide-y divide-blue-950 print:divide-slate-300 font-sans">
                      {dossier.top_bot_clusters.map((c) => (
                        <tr key={c.cluster_id} className="bg-[#050b18]/40 print:bg-white">
                          <td className="p-2.5 font-bold text-blue-300 print:text-black font-mono">{c.cluster_id}</td>
                          ...
                          <td className="p-2.5 text-blue-300 print:text-indigo-800 font-mono">{c.sample_handles.join(', ')}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="space-y-3">
                <h2 className="text-sm font-bold uppercase tracking-wider text-amber-400 border-b border-blue-950 pb-1 flex items-center gap-2 print:text-black print:border-black font-sans">
                  ...
                  <table className="w-full text-left text-xs border border-blue-950 rounded-xl overflow-hidden print:border-black font-sans">
                    ...
                    <tbody className="divide-y divide-blue-950 print:divide-slate-300 font-sans">
                      {dossier.deceptive_links.map((link, idx) => (
                        <tr key={idx} className="bg-[#050b18]/40 print:bg-white">
              ...
              <div className="space-y-3">
                <h2 className="text-sm font-bold uppercase tracking-wider text-emerald-400 border-b border-blue-950 pb-1 flex items-center gap-2 print:text-black print:border-black font-sans">
              ...
              {/* Footer */}
              <div className="pt-6 border-t border-blue-950 flex items-center justify-between text-[11px] text-slate-500 print:border-black print:text-black font-mono">
